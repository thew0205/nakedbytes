...
const char * SunspecGroupType_to_string(SunspecGroupType value){switch (value){case kGroup:return "kGroup";case kSync:return "kSync";default: return NULL;}}
...
const char * SunspecPointData_enum_to_string(SunspecPointData_enum value){switch (value){case uint16:return "uint16";case int16:return "int16";case uint32:return "uint32";case int32:return "int32";case uint64:return "uint64";case int64:return "int64";case float32:return "float32";case float64:return "float64";case string:return "string";case pad:return "pad";case enum16:return "enum16";case enum32:return "enum32";case enum64:return "enum64";case bitfield16:return "bitfield16";case bitfield32:return "bitfield32";case bitfield64:return "bitfield64";case sunssf:return "sunssf";case acc16:return "acc16";case acc32:return "acc32";case acc64:return "acc64";case eui48:return "eui48";case ipaddr:return "ipaddr";case ipv6addr:return "ipv6addr";default: return NULL;}}enum SunspecPointAccessType : uint8_t {

kR,
kRW,
};

const char * SunspecPointAccessType_to_string(SunspecPointAccessType value){switch (value){case kR:return "kR";case kRW:return "kRW";default: return NULL;}}enum SunspecPointMandatoryType : uint8_t {

kM,
kO,
};

const char * SunspecPointMandatoryType_to_string(SunspecPointMandatoryType value){switch (value){case kM:return "kM";case kO:return "kO";default: return NULL;}}
...
StringOffset id(){const int16_t offset = SUNSPECPOINTDEF_ID_OFFSET ;return StringOffset(&data_[offset]);}

StringOffset sf_id(){const int16_t offset = SUNSPECPOINTDEF_SF_ID_OFFSET ;return StringOffset(&data_[offset]);}

StringOffset units(){const int16_t offset = SUNSPECPOINTDEF_UNITS_OFFSET ;return StringOffset(&data_[offset]);}

StringOffset label(){const int16_t offset = SUNSPECPOINTDEF_LABEL_OFFSET ;return StringOffset(&data_[offset]);}

SunspecPointData_enum data_type() {return *reinterpret_cast<SunspecPointData_enum*>(&data_[SUNSPECPOINTDEF_DATA_TYPE_OFFSET ]);}

Union<SunspecPointData> data(){const int16_t offset = SUNSPECPOINTDEF_DATA_OFFSET - 2;return Union<SunspecPointData>(&data_[offset]);}
...
SunspecPointDef value(){ const int16_t offset = *reinterpret_cast<int16_t *>(data_);return SunspecPointDef(&data_[offset]);}};
...
StringOffset id(){const int16_t offset = SUNSPECGROUPPOINTDEF_ID_OFFSET ;return StringOffset(&data_[offset]);}

StringOffset count_point_id(){const int16_t offset = SUNSPECGROUPPOINTDEF_COUNT_POINT_ID_OFFSET ;return StringOffset(&data_[offset]);}

Vector<SunspecPointDefOffset> points(){const int16_t offset = SUNSPECGROUPPOINTDEF_POINTS_OFFSET ;return Vector<SunspecPointDefOffset>(&data_[offset]);}

Vector<SunspecGroupPointDefOffset> groups(){const int16_t offset = SUNSPECGROUPPOINTDEF_GROUPS_OFFSET ;return Vector<SunspecGroupPointDefOffset>(&data_[offset]);}

StringOffset label(){const int16_t offset = SUNSPECGROUPPOINTDEF_LABEL_OFFSET ;return StringOffset(&data_[offset]);}
...
SunspecGroupPointDef value(){ const int16_t offset = *reinterpret_cast<int16_t *>(data_);return SunspecGroupPointDef(&data_[offset]);}};
...
SunspecGroupPointDefOffset group(){const int16_t offset =SUNSPECMODELDEF_GROUP_OFFSET + 2* OFFSET_SIZE;return SunspecGroupPointDefOffset(&data_[offset]);}
...
SunspecModelDef value(){ const int16_t offset = *reinterpret_cast<int16_t *>(data_);return SunspecModelDef(&data_[offset]);}};
