...
SunspecPointData value(){ const int16_t offset = *reinterpret_cast<int16_t *>(data_);return SunspecPointData(&data_[offset]);}};enum SunspecPointAccessType {
