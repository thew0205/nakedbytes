...
model_def_file = f"{script_dir}/sunspec_model_struct.json"
...
with open(f"{script_dir}/sunspec_model_generated_struct.h", 'wt') as f:
...
with open(f"{script_dir}/model_1.json", 'r') as f:
    ...
    with open(f"{script_dir}/model_1_struct.bin", 'wb') as f:
        f.write(bin)
