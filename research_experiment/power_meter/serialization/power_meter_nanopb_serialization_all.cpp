...
void test_function()
{
    PowerMeter_MeterData data = {.id = "matthew777", .voltage = 230.5f, .current = 5.2f, .power = 1196.6f, .energy = 12345.6f, .freq = 50.0f, .pf = 0.98f, .alarms = 1234, .timestamp = "2025-06-54 06:54:13"};
    uint8_t buffer[1024];
...
size_t test_assert()
{
    ...
    volatile const char *id = data_deserialized.id;
    volatile const char *timestamp = data_deserialized.timestamp;
