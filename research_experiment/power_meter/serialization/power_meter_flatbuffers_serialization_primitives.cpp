...
void test_function()
{
    ...
    builder.Finish(PowerMeter::CreateMeterData(builder, flatbuffers::Offset<flatbuffers::String>(), 230.5f, 5.2f, 1196.6f, 12345.6f, 50.0f, 0.98f, 1234, flatbuffers::Offset<flatbuffers::String>()));
