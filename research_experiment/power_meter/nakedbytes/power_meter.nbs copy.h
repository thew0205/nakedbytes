...
#define PZEM004TV30DATA_MEMBER_SIZE_OFFSET 0
#define PZEM004TV30DATA_PAD2_OFFSET 2
#define PZEM004TV30DATA_VOLTAGE_OFFSET 4
#define PZEM004TV30DATA_CURRENT_OFFSET 8
#define PZEM004TV30DATA_POWER_OFFSET 12
#define PZEM004TV30DATA_ENERGY_OFFSET 16
#define PZEM004TV30DATA_FREQ_OFFSET 20
#define PZEM004TV30DATA_PF_OFFSET 24
#define PZEM004TV30DATA_ALARMS_OFFSET 28
...
#define PZEM004TV30DATA_SIZE 32
        ...
        {
            if (PZEM004TV30DATA_VOLTAGE_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
        ...
        {
            if (PZEM004TV30DATA_CURRENT_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
        ...
        {
            if (PZEM004TV30DATA_POWER_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
        ...
        {
            if (PZEM004TV30DATA_ENERGY_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
        ...
        {
            if (PZEM004TV30DATA_FREQ_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
        ...
        {
            if (PZEM004TV30DATA_PF_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
        ...
        {
            if (PZEM004TV30DATA_ALARMS_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET]))
            {
...
#define PZEM004TV30DATA_SIZE 32
        ...
        NAKEDBYTES_INLINE const float voltage() const
        {
            if (PZEM004TV30DATA_VOLTAGE_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
        ...
        NAKEDBYTES_INLINE const float current() const
        {
            if (PZEM004TV30DATA_CURRENT_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
        ...
        NAKEDBYTES_INLINE const float power() const
        {
            if (PZEM004TV30DATA_POWER_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
        ...
        NAKEDBYTES_INLINE const float energy() const
        {
            if (PZEM004TV30DATA_ENERGY_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
        ...
        NAKEDBYTES_INLINE const float freq() const
        {
            if (PZEM004TV30DATA_FREQ_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
        ...
        NAKEDBYTES_INLINE const float pf() const
        {
            if (PZEM004TV30DATA_PF_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
        ...
        NAKEDBYTES_INLINE const uint16_t alarms() const
        {
            if (PZEM004TV30DATA_ALARMS_OFFSET < *reinterpret_cast<const uint16_t *>(&data_[PZEM004TV30DATA_MEMBER_SIZE_OFFSET + 2 * OFFSET_SIZE]))
            {
...
#define OFFSET_SIZE 2
                                                                      ...
                                                                      const SerializeOffset<String> id)
    {
        ...
        *reinterpret_cast<int16_t *>(&(serializer->_buffer[serializer->_tail_offset + PZEM004TV30DATA_MEMBER_SIZE_OFFSET])) = PZEM004TV30DATA_SIZE;
        ...
        *reinterpret_cast<uint16_t *>(&(serializer->_buffer[serializer->_tail_offset + PZEM004TV30DATA_ID_OFFSET])) = id.offset - (serializer->_tail_offset + PZEM004TV30DATA_ID_OFFSET);
    ...
    inline SerializeOffset<Vector<PZEM004Tv30DataStruct>> serialize_vector_pzem004tv30data_struct(Serializer *const serializer, std::vector<PZEM004Tv30DataStruct> data_array)
    {
        ...
        *reinterpret_cast<uint16_t *>(&serializer->_buffer[serializer->_tail_offset]) = len;
        ...
        for (uint16_t i = 0; i < len; i++)
        {
            ...
            *reinterpret_cast<uint16_t *>(&(serializer->_buffer[serializer->_tail_offset + (PZEM004TV30DATA_SIZE * i) + PZEM004TV30DATA_ID_OFFSET])) = data_array[i].id.offset - (serializer->_tail_offset + (PZEM004TV30DATA_SIZE * i) + PZEM004TV30DATA_ID_OFFSET);
                                                         ...
                                                         const SerializeOffset<String> id)
    {
        ...
        *reinterpret_cast<uint16_t *>(&(serializer->_buffer[current_offset + PZEM004TV30DATA_ID_OFFSET])) = id.offset - (current_offset + PZEM004TV30DATA_ID_OFFSET);
