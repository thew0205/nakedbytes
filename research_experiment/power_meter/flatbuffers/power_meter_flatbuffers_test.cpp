...
#include "power_meter_generated.h"
#include <chrono>
...
int main()
{
    ...
    const char *file_name = "power_meter_data_flatbuffers.bin";
    ...
    {
        const MyGame::PZEM004Tv30Data *data = MyGame::GetPZEM004Tv30Data(buffer);
// data = GetPZEM004Tv30Data(buffer);
data = MyGame::GetPZEM004Tv30Data(buffer);
        // Print the data
